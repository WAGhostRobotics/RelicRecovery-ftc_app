...
@Autonomous(name="PhoneOnlyTest",group="Test")
public class PhoneOnlyTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()){
            ...
            if(vuMark != RelicRecoveryVuMark.UNKNOWN){
                ...
                telemetry.addData("Vuforia:", "Can See");
                telemetry.update();

            }else{

                telemetry.addData("Vuforia:", "Cannot See");
                telemetry.update();
